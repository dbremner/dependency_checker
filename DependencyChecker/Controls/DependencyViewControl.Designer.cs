...
namespace DependencyChecker.Controls
{
    partial class DependencyViewControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblDependsOn
            // 
            this.lblDependsOn.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.lblDependsOn.AutoEllipsis = true;
            this.lblDependsOn.ForeColor = System.Drawing.Color.Black;
            this.lblDependsOn.Location = new System.Drawing.Point(18, 27);
            this.lblDependsOn.Name = "lblDependsOn";
            this.lblDependsOn.Size = new System.Drawing.Size(486, 13);
            this.lblDependsOn.TabIndex = 4;
            this.lblDependsOn.Text = "The following items need to be installed before this one:";
            this.lblDependsOn.Visible = false;
            // 
            // pictureBox1
            // 
            ...
            this.Controls.Add(this.lblDependsOn);
