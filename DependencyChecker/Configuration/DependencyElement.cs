...
namespace DependencyChecker.Configuration
{
    ...
    public class DependencyElement : ConfigurationElement
    {
        ...
        private const string DependsOnProperty = "dependsOn";
        ...
        [ConfigurationProperty(DependsOnProperty)]
        public string DependsOn
        {
            get { return (string)base[DependsOnProperty]; }
            set { base[DependsOnProperty] = value; }
        }
    }
}